...
public class Musique extends javax.swing.JFrame {
    ...
    public Musique(Controle appli) {
        initComponents();
        this.ChargementMusique();
        controle = appli;
    }

    public Musique(Controle appli, String nom) {
        initComponents();
    ...
    public void ChargementMusique() {
        ...
        connn.connect();
        try {
            String q = "SELECT `Nom`, `Prix`, `Prix vrac` FROM `produit` WHERE `Categorie` = 'Musique'";
    ...
    public void RechercheNomProduit(String nom) {
        ...
        try {
            String q = "SELECT `Nom`, `Prix`, `Prix vrac` FROM `produit` WHERE `Categorie` = 'Musique' AND `Nom`= '" + nom + "'";
            pst = connn.conn.prepareStatement(q);
            rs = pst.executeQuery();
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (SQLException e) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Musique / Album");

        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\gameu\\Downloads\\Anis3\\Projet_Java\\caddy.png")); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\gameu\\OneDrive - Groupe INSEEC (POCE)\\Tibo ECE\\ING3\\Java\\BOUCHAKOR_Anis_SCHAPIRA_Emma_WEIBEL_Thibaut_Projet_Java\\music.png")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new Musique(controle).setVisible(true);
            }
        });
    }
