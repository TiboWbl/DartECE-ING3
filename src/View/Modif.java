...
public class Modif extends javax.swing.JFrame {
    ...
    public Modif(Controle appli) throws SQLException {
        controle = appli;
        Connexion Tibo = new Connexion();
        initComponents();
        ResultSet rs = Tibo.AjoutButton();
        while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Supprimer / Modifier ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ModifierProduit modif = null;
        try {
            modif = new ModifierProduit((String) jComboBox1.getSelectedItem(), controle);
